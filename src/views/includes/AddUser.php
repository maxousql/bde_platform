<section class="min-h-screen-custom flex items-center justify-center">
    <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-custom p-5 items-center justify-center m-10">
        <div class="px-8 md:px-16">
            <h2 class="font-bold text-2xl text-[#002D74] max-w-custom-form">Ajouter un utilisateur</h2>
            <form method="POST" action="/process_add_user" class="flex flex-col mt-2">
                <?php
                global $pdo;
                ...
                <label>Nom</label>
                <input class="p-2 mb-4 rounded-xl border" type="text" name="name" placeholder="Nom">
                <label for="name">Prénom</label>
                <input class="p-2 mb-4 rounded-xl border w-full" type="text" name="firstname" placeholder="Prénom">
                <label>Ecole</label>
                ...
                <input class="p-2 mb-4 rounded-xl border w-full" type="email" name="email" placeholder="Adresse email">
                <div class=" relative">
                </div>
                <label>Mot de passe</label>
                <input class="p-2 mb-4 rounded-xl border w-full" type="password" name="password"
