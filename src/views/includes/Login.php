    ...
    <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
        ...
        <div class="md:w-1/2 px-8 md:px-16">
            ...
            <form action="" class="flex flex-col gap-4">
                <input class="p-2 mt-8 rounded-xl border" type="email" name="email" placeholder="Adresse email">
                <div class="relative">
                ...
                <button class="bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300">Connexion</button>
            </form>
            ...
            <div class="mt-3 text-xs flex justify-between items-center text-[#002D74]">
                ...
                <button class="hover:scale-110 duration-300 text-sky-400">Inscrivez-vous</button>
            </div>
        </div>
