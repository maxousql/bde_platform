...
<body style="word-spacing:normal;background-color:#E7E7E7;">
    ...
    <div style="background-color:#E7E7E7;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            style="background:#092A43;background-color:#092A43;width:100%;">
            <tbody>
                <tr>
                    <td>
                                                            ...
                                                            <tr>
                                                                <td align="center" vertical-align="middle"
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" bgcolor="#FAC042"
                                                                                role="presentation"
                                                                                style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#FAC042;"
                                                                                valign="middle">
                                                                                <a href='verify-email/<?= $verify_token ?>'
                                                                                    style="display:inline-block;width:250px;background:#FAC042;color:#ffffff;font-family:'
                                                                                    ...
                                                                                    25px;mso-padding-alt:0px;border-radius:3px;"
                                                                                    target="_blank"> Valider mon email
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        sans-serif;font-size:14px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                                                        <a
                                                                            href="https://www.google.com">beedelyon@gmail.com</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
